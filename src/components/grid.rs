            ...
            .children(
                ...
                .map(|i| {
                    ...
                    rect()
                        ...
                        .background(Color::from_hex("#80191919").unwrap())
                        .into()
                })
                .collect::<Vec<Element>>()
            ).children(
                ...
                .flat_map(|i| {
                    (0..=cells - 1).map(move |j| {
                        label()
                            ...
                            .color(Color::from_hex("#80191919").unwrap())
                            .text(format!("{}{}", number_to_letters(i), j))
                            .position(Position::new_absolute().left((i as f32 * converted_grid_size) + self.margin + text_margin).top((j as f32 * converted_grid_size) + self.margin + text_margin))
                            .into()
                    })
                })
                .collect::<Vec<Element>>()
